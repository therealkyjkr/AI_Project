        ...
        def process_tracking_data(results, label_name=""):
            ...
            for box, track_id, cls_id in zip(boxes, track_ids, class_ids):
                ...
                if roi_x1 <= center_x <= roi_x2 and roi_y1 <= center_y <= roi_y2:
                    ...
                    # 최종 라벨 결정 (차량 모델의 경우 클래스 맵에서 이름 가져옴)
