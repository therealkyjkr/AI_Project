...
아래 순서대로 차근차근 따라 하면 자신의 컴퓨터에서 AI 코드를 돌려볼 수 있습니다.
(라즈베리파이용이 아닌 윈도우 PC에서 저장된 영상을 통해 테스트 해 보는 버전입니다.)
...
| **r** | **ROI(감시 구역) 설정** | 마우스 드래그로 ROI 영역을 설정합니다. 설정 후 **Space** 를 누르면 적용됩니다.  |
